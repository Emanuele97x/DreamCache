...
from transformers import CLIPTokenizer, CLIPTextModel, CLIPModel, AutoProcessor
import kornia
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77): #"cuda"
        super().__init__()
...
class FrozenClipImageFeatureExtractor(nn.Module):
    ...
    def get_projection(self):
        ...
        return  self.model.visual_projection, self.model.text_projection
