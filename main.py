...
def load_imageca(model, image_ca_path):  ##TODO modify 
...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        "--memory_path",
        type=str,
        default="/home/CORP/emanuele.aiello/memoryDiffusion/memories/multi_concept_DB",
        help="directory for logging dat shit",
    )
    parser.add_argument(
        "--mask_root",
        type=str,
        default="/home/CORP/emanuele.aiello/dreamboot_partition_train_mask",
        help="directory for logging dat shit",
    )
    parser.add_argument(
        "--scale_lr",
...
if __name__ == "__main__":
    ...
    manual_seed_everything(opt.seed)
    ...
    try:
        ...
        config.model.params.memory_path = opt.memory_path
        ...
        # image_ca_path = "/home/CORP/emanuele.aiello/memoryDiffusion/logs/pretrain/synthetic_personalization_2_umberto2024-10-19T14-27-14_memory_adapters_2nd_layer_SPATIALcat_synthetic_5_respective_mems/checkpoints/cross_attention-133999.pt"
        ...
        # config.data.params.train.params.mask_root = opt.mask_root
        # config.data.params.validation.params.mask_root = opt.mask_root
        # config.data.params.train.params.init_text = opt.init_word
        # config.data.params.validation.params.init_text = opt.init_word
        ...
        if not cpu:
            ngpu = len(lightning_config.trainer.gpus.strip(",").split(',')) #back to train with more than one GPU
        else:
            ngpu = 1
